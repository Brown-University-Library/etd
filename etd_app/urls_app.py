...
urlpatterns = [
        ...
        url(regex=r'^candidate/(?P<candidate_id>\d+)/upload/$', view=views.candidate_upload, name='candidate_upload'),
        url(regex=r'^candidate/(?P<candidate_id>\d+)/metadata/$', view=views.candidate_metadata, name='candidate_metadata'),
        url(regex=r'^candidate/(?P<candidate_id>\d+)/committee/$', view=views.candidate_committee, name='candidate_committee'),
        url(regex=r'^candidate/(?P<candidate_id>\d+)/committee/(?P<cm_id>\d+)/remove/$', view=views.candidate_committee_remove, name='candidate_committee_remove'),
        url(regex=r'^candidate/(?P<candidate_id>\d+)/preview/$', view=views.candidate_preview_submission, name='candidate_preview_submission'),
        url(regex=r'^candidate/(?P<candidate_id>\d+)/submit/$', view=views.candidate_submit, name='candidate_submit'),
