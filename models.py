...
class FormatChecklist(models.Model):
    ...
    title_page_issue = models.NullBooleanField(default=False, null=True, blank=True)
    title_page_comment = models.CharField(max_length=190, null=True, blank=True)
    signature_page_issue = models.NullBooleanField(default=False, null=True, blank=True)
    signature_page_comment = models.CharField(max_length=190, null=True, blank=True)
    font_issue = models.NullBooleanField(default=False, null=True, blank=True)
    font_comment = models.CharField(max_length=190, null=True, blank=True)
    spacing_issue = models.NullBooleanField(default=False, null=True, blank=True)
    spacing_comment = models.CharField(max_length=190, null=True, blank=True)
    margins_issue = models.NullBooleanField(default=False, null=True, blank=True)
    margins_comment = models.CharField(max_length=190, null=True, blank=True)
    pagination_issue = models.NullBooleanField(default=False, null=True, blank=True)
    pagination_comment = models.CharField(max_length=190, null=True, blank=True)
    format_issue = models.NullBooleanField(default=False, null=True, blank=True)
    format_comment = models.CharField(max_length=190, null=True, blank=True)
    graphs_issue = models.NullBooleanField(default=False, null=True, blank=True)
    graphs_comment = models.CharField(max_length=190, null=True, blank=True)
    dating_issue = models.NullBooleanField(default=False, null=True, blank=True)
    dating_comment = models.CharField(max_length=190, null=True, blank=True)
